...
(define XWING : Image (rotate 270 (center-pinhole (scale .03 (bitmap/file xwing)))))
(define TIE   : Image (rotate 270 (center-pinhole (scale .07 (bitmap/file tie)))))
(define EXPL  : Image (center-pinhole (scale .40 (bitmap/file expl))))
(define HIT   : Image (center-pinhole (scale .19 (bitmap/file expl))))
